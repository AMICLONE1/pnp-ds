...
export const SOLAR_PROJECTS = {
  vedvyas: {
    ...
    state: 'Odisha',
    description: 'A 100kW community solar project located in Vedvyas, Cuttack. This project provides reliable solar generation and a clean billing reference for the current host.',
  },
};
