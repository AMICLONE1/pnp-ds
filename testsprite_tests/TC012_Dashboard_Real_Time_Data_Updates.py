...
async def run_test():
    ...
    try:
        ...
        try:
            ...
            raise AssertionError("Test case failed: Dashboard real-time updates verification failed. Reserved capacity, cost savings, CO₂ reduction, or recent user activity data not displayed as expected.")
