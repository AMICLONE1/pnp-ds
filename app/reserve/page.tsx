      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="pt-28 pb-16 md:pt-32 md:pb-20">
          ...
          >
            ...
            >
              Reserve Your{" "}
              <span className="bg-gradient-to-r from-gold via-amber-400 to-gold bg-clip-text text-transparent" style={{ fontFamily: "'Montserrat', sans-serif" }}>
                Solar Capacity
              </span>
            </h1>

            <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto mb-8" style={{ fontFamily: "'Montserrat', sans-serif" }}>
