...
export function QuickSavingsDemo() {
  ...
  return (
    <section className="py-24 bg-gradient-to-br from-forest via-forest-light to-forest-dark relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <ScrollAnimation direction="fade">
          <div className="text-center mb-12">
            <p className="text-sm text-white/70 mb-4">Drag the slider to see instant savings calculation</p>
          </div>
        </ScrollAnimation>

        <div className="max-w-4xl mx-auto">
          <GlassCard className="p-8 md:p-12 bg-forest/90 backdrop-blur-xl border-forest-light/30">
            <div className="space-y-8">
              ...
              <div className="text-center py-6">
                <motion.div
                  ...
                  className="inline-block bg-gradient-to-br from-forest-dark to-forest text-white rounded-2xl p-8 shadow-2xl border border-forest-light/30"
                >
                  <div className="flex items-center justify-center gap-3 mb-3">
                    <TrendingUp className="h-6 w-6 text-gold" />
                    <span className="text-base font-medium text-white/90">You&apos;ll save</span>
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-6 border-t border-white/20">
                <div className="flex items-center gap-3 p-4 bg-gold/20 rounded-xl border border-gold/30">
                  ...
                  <div>
                    <p className="text-xs text-white/70 mb-1">Annual Savings</p>
                ...
                <div className="flex items-center gap-3 p-4 bg-success/20 rounded-xl border border-success/30">
                  ...
                  <div>
                    <p className="text-xs text-white/70 mb-1">CO₂ Offset</p>
                    <p className="text-2xl font-bold text-white">
                ...
                <div className="flex items-center gap-3 p-4 bg-energy-blue/20 rounded-xl border border-[#00BCD4]/30">
                  ...
                  <div>
                    <p className="text-xs text-white/70 mb-1">Savings Rate</p>
                    <p className="text-2xl font-bold text-white">{savingsPercent}%</p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-4 pt-4">
                <div className="text-center p-4 bg-white/10 rounded-xl border border-white/20">
                  ...
                  <div className="text-sm text-white/70">Solar Capacity Needed</div>
                </div>
                <div className="text-center p-4 bg-white/10 rounded-xl border border-white/20">
              ...
              <div className="pt-6">
                <Button
                  variant="secondary"
                  size="lg"
                  className="w-full text-lg py-6 group bg-gold hover:bg-gold-light text-charcoal font-bold glow-button"
                  onClick={() => {
